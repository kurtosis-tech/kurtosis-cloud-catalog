      ...
      <Flex flexDirection={"column"} width={"100%"} h={"100%"} gap={"32px"}>
        ...
        <Flex gap={"32px"} h={"100%"} w={"100%"}>
          ...
          <Flex flexDirection={"column"} gap={"16px"} flex={"1"}>
            <RunKurtosisPackageButton kurtosisPackage={kurtosisPackage} size={"lg"} onClick={handlePackageRunClicked} />
            <InputGroup size={"lg"}>
  ...
  return (
    <Flex gap={"22px"} w={"100%"}>
      <Image
        ...
        src={kurtosisPackage.iconUrl || `/logo.png`}
